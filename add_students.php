...
<br>
<p class="text-xl">Add Student</p>
<form action="insert_into_students.php" method="POST" enctype="multipart/form-data">
<br>
...
<div class="p-5">
        ...
        <input type="text" id="student_ID" name="student_ID" style="width:330px;" required>
        <br><br>
        ...
        <select id="course" name="course" style="width:330px;" style="width:330px;" required>
        <option></option>
        ';
...
<div class="p-5">
        ...
        <select id="class" name="class" style="width:330px;" style="width:330px;" required>
        <option></option>
...
<input type="submit" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" value="Add Student">
</form>
</div>
</center>
';     
