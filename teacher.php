...
$sql="SELECT Teacher_ID, Full_Name from teachers where Username='$username'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
$row= $result->fetch_assoc();
...
echo'
<center>
<p class="text-4xl">Welcome <b>'. $fullName .' </b></p>
</center>
<br>
...
echo '
  <a href="teacher_attendance_details.php?Subject_ID=' . $row['Subject_ID'] . '" class="subject-box" data-class="' . $row['Class'] . '" data-course="' . $row['Name'] . '">
      <div class="grid grid-rows-3">
          <div>
