...
<div class="content">
 ...
 echo'</table>
 <br><br>
 <div style="width:500px; height:330px; border:3px solid black;">
 <br>
 <center>
 <p class="text-2xl">Create Department</p>
 <br>
 <form method="POST" action="add_department.php">
 <label for="Department_ID">Department ID:</label><br>
        <input type="text" id="Department_ID" name="Department_ID" style="width:330px;" required>
        <br><br>

        <label for="Department_Name">Department Name:</label><br>
        <input type="text" id="Department_Name" name="Department_Name" style="width:330px;" required>
        <br><br>
        <input type="submit" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" value="Create Department">
        <br>
 </form>
 </center>
 </div>
