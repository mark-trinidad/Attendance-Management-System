...
while ($row = $result->fetch_assoc()) {
    ...
    echo '<p class="text-xl"><strong>' . $studentCounter . '. ' . $row['Full_Name'] . '</strong></p>';
    echo '</div>';

    // Column 2: Radio Buttons
    echo '<div class="grid-item radio-buttons">';
    echo '<input type="radio" name="attendance[' . $row['Full_Name'] . ']" value="Present" id="present_' . $row['Full_Name'] . '"> <label for="present_' . $row['Full_Name'] . '">Present</label>&nbsp&nbsp';
    echo '<input type="radio" name="attendance[' . $row['Full_Name'] . ']" value="Absent" id="absent_' . $row['Full_Name'] . '"> <label for="absent_' . $row['Full_Name'] . '">Absent</label>&nbsp&nbsp';
    echo '<input type="radio" name="attendance[' . $row['Full_Name'] . ']" value="Late" id="late_' . $row['Full_Name'] . '"> <label for="late_' . $row['Full_Name'] . '">Late</label>&nbsp&nbsp';
    echo '</div>';

    // Close the row for each student
    echo '</div>';
