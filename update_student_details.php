    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_GET['Student_ID'])) {
        ...
        if ($password == $conpassword) {
            ...
            if ($result) {
                ...
                $sqlUsers = "UPDATE users SET Username='$susername', Password='$encryption' WHERE Username='$username'";
                $conn->query($sqlUsers);
                ...
                echo '<script>alert("Student details successfully updated.");';
                echo 'window.location.href = "modify_student.php?Student_ID=' . $Student_ID . '";';
                echo '</script>';
                exit();
            } else {
            ...
            window.location.href = "modify_student.php?Student_ID=' . $Student_ID . '";
            </script>';
        }
    }
} else {
