...
<div class="content">
 <?php
  ...
  <a href='add_teachers.php' class='grid-item'>
    <div class='p-6'></div>
    <div class='p-6 text-4xl'><b><div><center>Add</center></div></b></div>
    <div class='p-6'></div>
  </a>
  <a href='update_teachers.php' class='grid-item'>
    <div class='p-6'></div>
    <div class='p-6 text-4xl'><b><div><center>Update</center></div></b></div>
    <div class='p-6'></div>
  </a>
  </div>
  <div class='grid grid-rows-2 gap-5'>
  <a href='view_teachers.php' class='grid-item'>
    <div class='p-6'></div>
    <div class='p-6 text-4xl'><b><div><center>View</center></div></b></div>
    <div class='p-6'></div>
  </a>
  <a href='delete_teachers.php' class='grid-item'>
    <div class='p-6'></div>
    <div class='p-6 text-4xl'><b><div><center>Delete</center></div></b></div>
    <div class='p-6'></div>
  </a>
  </div>
  </div><br><br>";
